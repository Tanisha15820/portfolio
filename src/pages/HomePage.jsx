          ...
          <div className="relative z-20 px-5 sm:px-6 md:px-14 pt-28 md:pt-32 pb-14 min-h-[92vh] flex items-center">
            ...
            <div className="grid lg:grid-cols-2 gap-14 lg:gap-10 items-center w-full">
              ...
              <div className="max-w-[750px]">
                ...
                <h1 className="text-secondary leading-[0.95] font-black text-[2.7rem] sm:text-[3.5rem] md:text-[5rem] whitespace-normal md:whitespace-nowrap">
                  Digital Growth
                  <br />
                  Expert
                </h1>

                <p className="text-secondary/80 text-sm sm:text-base md:text-lg mt-6 max-w-lg leading-7">
                ...
                <div className="mt-8 flex gap-4 flex-wrap">
                  ...
                  <button className="bg-secondary text-black px-5 sm:px-6 py-3 rounded-full font-semibold text-sm hover:scale-105 duration-300 w-full sm:w-auto">
                    View Projects
                  </button>

                  <button className="border border-secondary text-secondary px-5 sm:px-6 py-3 rounded-full font-semibold text-sm hover:bg-secondary hover:text-black duration-300 w-full sm:w-auto">
                    Contact Me
                  </button>
